...
*/
		...
		o.prototype.Q = function(e) {
			...
			var C = function(t, n, r) {
				...
				default.detect(i), a = '<span class="vsys"><i class="fab fa-' + (["xiaomi"].includes(i.browser.toLowerCase()) ? "mobile-alt fas" : i.browser.toLowerCase()) + '"></i>' + " " + i.browser + " " + i.version + "</span>" + " " + ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios", "apple", "macos"].includes(i.os.toLowerCase()) ? "apple" : i.os.toLowerCase()) + '"></i>' + " " + i.os + " " + i.osVersion + "</span>")), "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
